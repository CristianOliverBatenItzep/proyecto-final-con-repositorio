...
void guardarEstudiante(const Estudiante& estudiante) {
    ofstream file("estudiantes_registrados.txt", ios::app);
    if (file.is_open()) {
        file << "Codigo: " << estudiante.codigo << "\n"
             << "Nombres: " << estudiante.nombres << "\n"
             << "Apellidos: " << estudiante.apellidos << "\n"
             << "Carrera: " << estudiante.carrera << "\n"
             << "Departamento: " << estudiante.departamento << "\n"
             << "Municipio: " << estudiante.municipio << "\n"
             << "Aldea: " << estudiante.aldea << "\n"
             << "Telefono Personal: " << estudiante.telefonoPersonal << "\n"
             << "Telefono Casa: " << estudiante.telefonoCasa << "\n"
             << "Telefono Emergencia: " << estudiante.telefonoEmergencia << "\n"
             << "Fecha de Nacimiento: " << estudiante.fechaNacimiento << "\n"
             << "Edad: " << estudiante.edad << "\n"
             << "Anio de Ingreso: " << estudiante.anioIngreso << "\n"
             << "Correo Electronico: " << estudiante.correoElectronico << "\n"
             << "------------------------\n";
        file.close();
        cout << "Estudiante guardado en archivo exitosamente." << endl;
    } else {
...
void registrarEstudiante() {
    ...
    guardarEstudiante(estudiante); // Guarda el estudiante en el archivo
}
...
void asignarCurso(Estudiante& estudiante) {
    ...
    vector<Curso>* cursos = NULL;  // Cambiado nullptr a NULL para compatibilidad
    switch (ciclo) {
